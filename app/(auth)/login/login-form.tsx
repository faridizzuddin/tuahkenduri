...
export function LoginForm() {
  ...
  return (
    <form action={action}>
      <div className="field"><label htmlFor="email">E-mel hos</label><div className="login-input"><Mail /><input className="input" id="email" name="email" type="email" autoComplete="email" required placeholder="hos@contoh.com" /></div></div>
      ...
      <small className="text-center text-xs leading-5 text-muted">Akses untuk hos kenduri yang diluluskan sahaja.</small>
    </form>
  );
}
