...
export function ParticipantManager({ participants }: { participants: Participant[] }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog open={!!confirmingAddition} title="Sahkan maklumat peserta" description={confirmingAddition ? `Nombor tuala ${confirmingAddition.towel_number} — ${confirmingAddition.name}. Pastikan nombor dan nama ini betul sebelum disimpan.` : ""} confirmLabel="Ya, Tambah Peserta" danger={false} onClose={() => setConfirmingAddition(null)} onConfirm={confirmAddition} />
